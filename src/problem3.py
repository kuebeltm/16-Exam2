...
def main():
    ...
    # -------------------------------------------------------------------------
    todd = Person(19)
    print('Todd is currently the age of: ', todd.get_age())
    todd.celebrate_birthday()
    print('Todd celebrates a birthday!, he is now the age of ', todd.get_age())
    todd.celebrate_birthdays(3)
    print('Todd celebrates 3 birthdays and is now ', todd.get_age())
    older = todd.older_person()
    print('There is a man who is older than Todd. He is ', older.get_age())
